...
const QuoteModal: React.FC<QuoteModalProps> = ({ isOpen, onClose }) => {
  ...
  }, [sirenInput, sirenValidation.isValid]);
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-white p-6 text-left align-middle shadow-xl transition-all">
                <div className="flex justify-between items-center mb-6">
                  <Dialog.Title as="h3" className="text-2xl font-garamond text-blue-dark">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        maxLength={9}
                        className={`w-full p-3 pr-10 border rounded-md focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold ${
                          sirenInput.length > 0 
                  ...
                  <div>
                    ...
                    <input
                      ...
                      min="1"
                      placeholder="Ex: 50"
                      className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      name="ctn_code"
                      required
                      className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold bg-white"
                    >
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="had_ip_gt_10_last_4y" className="ml-2 block text-sm text-gray-700">
